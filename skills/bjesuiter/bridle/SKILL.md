...
metadata: {"clawdbot":{"emoji":"🐴","os":["darwin","linux"],"requires":{"bins":["bridle"]},"install":[{"id":"brew","kind":"brew","formula":"neiii/bridle/bridle","bins":["bridle"],"label":"Install bridle via Homebrew"},{"id":"cargo","kind":"shell","command":"cargo install bridle","bins":["bridle"],"label":"Install bridle via Cargo"}]}}
---
